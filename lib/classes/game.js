...
*/
Game.prototype.incrementarPuntaje = function(value){
    this.puntaje += value;
    let elem = document.getElementById("puntaje");
    elem.innerHTML = this.puntaje;
}

/*
Pinta el numero de vidas
*/
Game.prototype.dibujarVidas = function(){
    let vidas = document.getElementById("vidas");
    vidas.innerHTML = "";
    for(let i =0; i<this.vidas; i++){
        let vida = document.createElement("img");
        vida.src = "assets/pacman_live.png";
    ...
    if(this.blinky.collides(this.pacman.x, this.pacman.y)){
        if(this.blinky.behaviour != "frightened" && this.blinky.behaviour != "returning"){
            ...
            if(this.points_notification.length == 0 && this.blinky.behaviour != "returning"){
                ...
                this.incrementarPuntaje(this.points_per_ghost);
...
Game.prototype.toggleSound = function() {
    let sound_button = document.getElementById("volumen");
    if(this.sound){
        this.sound = false;
        ...
        console.log("Desactive el sonido " + this.sound);
    }
        
    else{
        this.sound = true;
        sound_button.style.backgroundImage = "url('assets/sound_on.png')";
        console.log("Active el sonido " + this.sound);
    }
...
Game.prototype.extraLife = function(){
    if(this.puntaje >= EXTRA_LIFE_SCORE && !this.extra_life){
        this.vidas++;
