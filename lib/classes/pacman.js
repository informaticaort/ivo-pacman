...
*/
Pacman.prototype.comerBola = function(game){    
    if(this.mode == "pause")
    ...
    if(eated_ball == 1){ //bola normal vale 10pts
        ...
        game.incrementarPuntaje(CHERRY_SCORE);
        ...
        if(game.sound)
                game.sounds["eat_fruit"].play();
        game.incrementarPuntaje(STRAWBERRY_SCORE);
        if(game.points_notification.length == 0){
        ...
        if(game.sound)
                game.sounds["eat_fruit"].play();
        game.incrementarPuntaje(ORANGE_SCORE);
        if(game.points_notification.length == 0){
        ...
        if(game.sound)
                game.sounds["eat_fruit"].play();
        game.incrementarPuntaje(APPLE_SCORE);
        if(game.points_notification.length == 0){
        ...
        if(game.sound)
                game.sounds["eat_fruit"].play();
        game.incrementarPuntaje(GRAPES_SCORE);
        if(game.points_notification.length == 0){
        ...
        if(game.sound)
                game.sounds["eat_fruit"].play();
        game.incrementarPuntaje(GALAXIAN_SCORE);
        if(game.points_notification.length == 0){
        ...
        if(game.sound)
                game.sounds["eat_fruit"].play();
        game.incrementarPuntaje(BELL_SCORE);
        if(game.points_notification.length == 0){
