...
window.onload = function () {
    ...
    */
    function render() {
        ...
        //dibujamos pacman
        //obtenemos el frame que tenga actualmente el objeto pacman  
    ...
    gesture_zone.addEventListener("touchstart", function (event) {
        controller.handleGesture.call(controller, event);
    });
    gesture_zone.addEventListener("touchmove", function (event) {
        controller.handleGesture.call(controller, event);
    });
